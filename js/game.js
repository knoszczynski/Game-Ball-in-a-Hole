...
export default class GameHole{
    ...
    restartGame(){
        ...
        new Counter({ endGame: () => this.endGame(), score: () => this.actualScore });
    }
    ...
    showScore(){
        ...
        document.querySelector('.modal-content').appendChild(new RestartButton({ restart: () => this.restartGame() }));
    }
